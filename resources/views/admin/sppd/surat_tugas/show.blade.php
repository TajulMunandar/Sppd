                        ...
                        <tbody>
                            @foreach ($surats as $surat)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {{ Carbon\Carbon::parse($surat->tanggal_kembali)->format('d/m/Y') }}
                                    </td>
                                    <td class="text-center">
                                        @if ($surat->dokumen)
                                            <a href="{{ asset('storage/' . $surat->dokumen) }}" target="_blank">
                                                <img src="{{ asset('icons/pdf.svg') }}" width="40"
                                                    alt="{{ $surat->nomor_st }}">
                                            </a>
                                        @else
                                            -
                                ...
                                <x-form_modal file>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea type="text" class="form-control @error('tujuan') is-invalid @enderror" name="tujuan" id="tujuan"
                                            required>{{ old('tujuan', $surat->tujuan) }}</textarea>
                                        @error('tujuan')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="mb-3">
                                        <label for="dokumen" class="form-label">Dokumen ST</label>
