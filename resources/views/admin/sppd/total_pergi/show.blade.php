                            ...
                            @foreach ($pergis as $pergi)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if ($pergi->dokumen)
                                            <a href="{{ asset('storage/' . $pergi->dokumen) }}" target="_blank">
                                                <img src="{{ asset('icons/pdf.svg') }}" alt="file-{{ $pergi->id }}"
                                                    width="40">
                                            </a>
                                        @else
                                            -
                                ...
                                <x-form_modal file>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date"
                                            ...
                                            value="{{ old('tgl_penerbangan', $pergi->tgl_penerbangan->format('Y-m-d')) }}"
                                            required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('total_harga', number_format($pergi->total_harga, 0, ',', '.')) }}"
                                            required>
                                        @error('total_harga')
                                            <div class="invalid-feedback">
                                                {{ $message }}
